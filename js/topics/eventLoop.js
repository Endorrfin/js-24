...
// 🟧 EXAMPLE IV - In what order will console.log be output?
function executionSequence() {
    console.log('🏃‍♂️‍➡️ start');
...
// 🟧 EXAMPLE V - In what order will console.log be output?
function executionSequence2() {
    console.log('🏃‍♂️‍➡️ start');
...
// console.log(executionSequence2());


// 🟧 EXAMPLE VI - In what order will console.log be output?
function executionSequence3() {
...
// console.log(executionSequence3());


// 🟧 EXAMPLE VII - In what order will console.log be output?
function executionSequence4() {
    console.log('🏃‍♂️‍➡️ start');
...
// console.log(executionSequence4());



// 🟧 EXAMPLE VIII - In what order will console.log be output?
const executionSequence5 = () => {
    console.log(1);
...
// console.log(executionSequence5());
