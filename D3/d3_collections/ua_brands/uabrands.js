...
function createColorScale(data) {
  // const scale = d3.scaleOrdinal(d3.schemeTableau10); // NO
  // const scale = d3.scaleOrdinal(d3.schemeSet3);
  // const scale = d3.scaleOrdinal(d3.schemeSet2);
  // const scale = d3.scaleOrdinal(d3.schemeSet1); // NO
  // const scale = d3.scaleOrdinal(d3.schemePastel2); // NO
  // const scale = d3.scaleOrdinal(d3.schemePastel1); // NO
  // const scale = d3.scaleOrdinal(d3.schemePaired); // NO
...
function createAxisUpdater(svg) {
  ...
  return (_, transition) => {
    ...
    // g.selectAll(".tick:not(:first-of-type) line").attr("stroke", "lightgreen");
...
async function initialize() {
  try {
    ...
    const errorElement = document.getElementById('error');
    errorElement.textContent = `Error loading data: ${error.message}. Make sure the CSV file is at './files/data.csv'`;
