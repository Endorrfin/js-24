...
async function loadDataAndCreateChart() {
  try {
    ...
    const data = await d3.json('./files/data_ua.json');
...
function createLegend(data) {
  ...
  const levelLabels = [
    'Країна',      // Level 0 - Root level
    'Область',       // Level 1 - Oblast
    'Район',     // Level 2 - Raion
    'Громада',      // Level 3 - Hromada
    'Населений пункт / Кількість'    // Level 4 - Settlement
  ];
